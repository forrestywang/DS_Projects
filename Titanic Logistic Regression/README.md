...
The constants were used to categorize the variables in the data set and improve readability. 'Survived' was the dependent variable because it depended on the independent variables 'Pclass', 'Sex', and 'Age'. 'Name', 'Siblings/Spouses Aboard', and 'Parents/Children Aboard' didn't affect the person's survival, so these variables were not included. 'Sex' was a categorical variable because its values were non-numerical.
